    ...
    if clicks is not None:
        try:
            ...
            if onepyropath != '' and downloadloc !='':
                ...
                col = [0,44,9,25,26,29,34,35,38,53,54] #Select the columns of focus
                ...
                if oneshift != '':
                    onedf['temp'] = onedf.temp.shift(-int(oneshift)) #44
                    onedf['Bar'] = onedf.temp.shift(-int(oneshift)) #9
                    onedf['SCO2'] = onedf.temp.shift(-int(oneshift)) #25
                    onedf['SCH4'] = onedf.temp.shift(-int(oneshift)) #26
                    onedf['CO2'] = onedf.temp.shift(-int(oneshift)) #34
                    onedf['CH4'] = onedf.temp.shift(-int(oneshift)) #35
                    onedf['H2'] = onedf.temp.shift(-int(oneshift)) #38
                    onedf['set'] = onedf.temp.shift(-int(oneshift)) #53
                    onedf['power'] = onedf.temp.shift(-int(oneshift)) #54
                onedf['index'] = onedf['i']
